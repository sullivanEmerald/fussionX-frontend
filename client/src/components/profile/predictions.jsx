...
import Stakes from "./stakefilter";

const Predictions = () => {
    const {predictions} = usePredictions()
    const [getStakes, setStake] = useState([])
                        ...
                        {showFreePrediction && (
                            ...
                            <table class="custom-table">
                                ...
                                <tbody className="tableBody">
                                    {getStakes.map((item, i) => (
                                        <tr key={i} style={{position : 'relative'}} className={ i === predictions.length - 1 ? 'last-row' : 'table-body-row' }>
