    ...
    return (
        <>
            <section className="test-sect relative">
                    <img src="/images/testimonials/line.png" className="test-image" style={{ position : 'absolute'}} />
                    <img src="/images/testimonials/ellipse.png" className="test-image" style={{ position : 'absolute'}} />
                <div>
                    <div>
                        <p>Testimonials!</p>
